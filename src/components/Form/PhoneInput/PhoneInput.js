...
function Input({
  ...
  const handleOnChange = (e) => {
    formOnChange(id, e.target.value?.replace(/\D/g, ""));
  ...
  return (
    <div className={`phone-input-component ${className}`}>
      {/* <div>
        <label className="input_label phone-input">{label}</label>
      </div> */}
      <div style={{ position: "relative" }}>
        ...
        <input
          ...
          className={`input_component ${inputClassname} mobile_fields_focus`}
          id={id}
          style={style}
