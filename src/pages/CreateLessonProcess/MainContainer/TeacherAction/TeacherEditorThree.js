...
const TeacherEditorThree = ({
  ...
  let blocksFromHTML = convertFromHTML(textPlaceholder);
  ...
  const onChange = (editorState) => {
    ...
    handleFormChange("textPlaceholder", htmlText);
  };
  ...
  return (
    <div className="method-editor-large-container">
      <div className="method-editor-large" onClick={focus}>
        <Textarea
          label="
        Հստակ ձևակերպումներ, հարցեր, գաղափարներ և այլն"
        />
      </div>
    </div>
  );
...
const mapStateToProps = (state, ownProps) => {
  return {
    textPlaceholder: state.formReducer.textPlaceholder ?? "<p></p>",
...
export default connect(mapStateToProps, mapDispatchToProps)(TeacherEditorThree);
